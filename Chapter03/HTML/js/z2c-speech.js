...
function initPage ()
{
  // ALL CODE BELOW COPIES FROM THE ANSWERS FILE!
  ...
  _mic.on("click", function ()
    {
      ...
      {
	console.log("Mic button ok, turning on speech by talking to server ...");
  ...
  _stop.on("click",  function() {
    console.log("Stopping text-to-speech service in _stop.on function...");
